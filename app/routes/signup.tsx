    ...
    <div className="min-h-screen bg-atlas-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold text-atlas-white mt-4 font-display">{t.auth.createAccount}</h1>
          <p className="text-sm text-atlas-gray3 mt-1">{t.auth.createSubtitle}</p>
        </div>
        ...
        <div className="bg-atlas-card border border-atlas-border rounded-xl p-6">
          <Form method="post" className="flex flex-col gap-4">
            <div>
              <label className="block text-xs font-semibold text-atlas-gray3 mb-1.5">{t.auth.name}</label>
              <input
                type="text"
                name="name"
                autoComplete="name"
              ...
              {actionData?.errors?.name && (
                <p className="text-xs text-red-400 mt-1">{actionData.errors.name}</p>
              )}
            </div>
            <div>
            ...
            <div>
              <label className="block text-xs font-semibold text-atlas-gray3 mb-1.5">{t.auth.confirmPassword}</label>
              <input
                type="password"
              ...
              {actionData?.errors?.confirmPassword && (
                <p className="text-xs text-red-400 mt-1">{actionData.errors.confirmPassword}</p>
              )}
            </div>
            <button
              type="submit"
        ...
        <p className="text-center text-sm text-atlas-gray3 mt-5">
          {t.auth.hasAccount}{" "}
          <Link to="/login" className="text-atlas-purple font-semibold no-underline hover:underline">
            {t.auth.signInLink}
          </Link>
        </p>
      </div>
